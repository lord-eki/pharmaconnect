...
namespace App\Filament\Operation\Resources\Orders;
...
use App\Filament\Operation\Resources\Orders\Tables\OrdersTable;
...
class OrderResource extends Resource
{
    ...
    {
        $count = static::getModel()::where('status', 'pending_review')->count();
        return $count === 1 ? '1 order pending review' : "{$count} orders pending review";
    }
}

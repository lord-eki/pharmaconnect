<div class="space-y-4">
    ...
    @foreach ($orders as $index => $order)
        ...
        <div class="rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            {{-- Order Header --}}
            <div
                class="bg-primary-50 dark:bg-primary-900/20 px-4 py-3 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
            ...
            <div
                class="flex flex-nowrap justify-between items-start gap-6 p-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
                ...
                <div class="flex items-start gap-2 min-w-max">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            {{ $order->supplier->address ?? 'No address' }}
                        </p>
                    </div>
                </div>
    ...
    {{-- Grand Total Summary --}}
    <div
        class="rounded-lg border-2 border-primary-200 dark:border-primary-800 bg-primary-50 dark:bg-primary-900/20 p-4">
